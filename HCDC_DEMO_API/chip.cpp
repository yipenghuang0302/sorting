	...
	anaOutPinBase (anaOutPinBase)
{
	...
	// TODO
	tiles = new Tile[4] {
		Tile (this, tileRow0, tileCol0, spiSSPinBase+0, spiMisoPinBase+0, anaOutPinBase+24),
		Tile (this, tileRow0, tileCol1, spiSSPinBase+1, spiMisoPinBase+1, anaOutPinBase+16),
		Tile (this, tileRow1, tileCol0, spiSSPinBase+2, spiMisoPinBase+2, anaOutPinBase+8),
		Tile (this, tileRow1, tileCol1, spiSSPinBase+3, spiMisoPinBase+3, anaOutPinBase+0)
	};
...
void Fabric::Chip::spiDriveChip (
	...
	digitalWrite (tiles[0].spiSSPin, LOW);
	digitalWrite (tiles[1].spiSSPin, LOW);
	digitalWrite (tiles[2].spiSSPin, LOW);
	digitalWrite (tiles[3].spiSSPin, LOW);
	spiDrive ( selRow, selCol, selLine, cfgTile );
	digitalWrite (tiles[0].spiSSPin, HIGH);
	digitalWrite (tiles[1].spiSSPin, HIGH);
	digitalWrite (tiles[2].spiSSPin, HIGH);
	digitalWrite (tiles[3].spiSSPin, HIGH);
}
